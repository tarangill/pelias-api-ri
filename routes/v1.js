...
function addRoutes(app, peliasConfig) {
  ...
  var routers = {
    ...
    autocomplete: createRouter([
      ...
      middleware.requestLanguage,
      middleware.sizeCalculator(),
      middleware.detectCategoriesFromText(esclient),
      controllers.search(peliasConfig, esclient, queries.autocomplete, not(hasResponseDataOrRequestErrors), queries.categories_detected),
      middleware.distance('focus.point.'),
      middleware.confidenceScore(peliasConfig.api),
      middleware.applyOverrides(),
      middleware.dedupe(),
